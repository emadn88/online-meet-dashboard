                                ...
                                <div>
                                    <div class="input-group">
                                        <div class="input-group-append">
                                            <a class="btn btn-outline-success" href="{{url('https://wa.me/'.$room->mobile.'?text=https://dash.almajd.link/join/'.$room->name)}}" target="_blank" title="send whatsapp">
                                                <img src="{{asset('whatsapp.png')}}" style="width: 20px">
                                            </a>
                                        </div>
                                        <input type="text" value="{{'https://dash.almajd.link/join/'.$room->name}}" class="form-control" id="copyInput{{$room->id}}">
                                        <div class="input-group-append">
